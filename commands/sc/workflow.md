...
2. **Plan**: Use 3-stage planning system for comprehensive workflow generation:
   - `/sc:plan` - Generate initial structured plan with alternatives
   - `/sc:plan-review` - Stress-test with 5 adversarial lenses
   - `/sc:plan-final` - Consolidate into execution-ready workflow
